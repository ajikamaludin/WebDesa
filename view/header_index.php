...
<head>
    ...
    <meta name="Description" content="<?= 'aji kamaludin '.getPengaturan()['deskripsi'].' '.getPengaturan()['nama'];?>" />
    <meta name="Keywords" content="<?= 'aji kamaludin '.getPengaturan()['deskripsi'].' '.getPengaturan()['nama'];?>" />
    <!-- Title -->
